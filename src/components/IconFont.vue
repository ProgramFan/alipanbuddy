...
import {
  ...
  Link, Link2, LogOut, Camera as Camera2, Menu, EyeOff, Move, Film, Music,
  Moon, Network, BellRing, ArrowUpDown, Pause, Eraser, Undo2, RotateCw,
  Trash, Bot, SearchCheck, Rss, Crown as CrownVip, ShieldCheck, Search, Server, Settings,
  Gauge, Layers, Sparkles, Cast, Layout, Upload,
  Tag, FileText as DocIcon,
  Image, AlertCircle, Files, Star, Grid3X3, Palette, AlertTriangle, Shuffle,
  RadioTower, Compass, FileVideo as FileVideoIcon,
