...
const map = {
  ...
  // No native ARM64 aria2c build is published upstream; Windows on ARM runs the
  // x64 binary under emulation, so both Windows targets ship the same executable.
  'aarch64-pc-windows-msvc': 'win32/x64/aria2c.exe'
}
